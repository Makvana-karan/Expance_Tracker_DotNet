...
namespace Expance_Tracker.Controllers
{
    public class CatagoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatagoryId,Title,Icon,Type")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatagoryId,Title,Icon,Type")] Catagory catagory)
        {
